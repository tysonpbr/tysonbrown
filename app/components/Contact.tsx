...
const Contact = () => {
  return (
    <div className="h-full w-[100vw] flex flex-col lg:flex-row gap-16 items-center justify-center px-8">
      <div className="flex flex-col justify-start text-black gap-8 max-w-[70vw] lg:max-w-[40vw] self-center">
        <div className=''>
        ...
        <div className='flex flex-row justify-center gap-12 lg:gap-24 mt-4 lg:mt-8'>
          <button className='w-8 h-8 lg:w-16 lg:h-16 hover:scale-150 ease-in-out duration-300'>
